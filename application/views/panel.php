...
<div id="barra_panel" style="text-align: center;"> 
    <div id="columna_botones">
        <a id ="binicio" class="boton3" href="https://www.loadingstudios.archive.tornadocore.es/panel/index/estado/inicio">Inicio</a>
        <a id ="bfacturacion" class="boton3" href="https://www.loadingstudios.archive.tornadocore.es/panel/index/estado/facturacion">Facturación</a>
        <a id ="bsoporte" class="boton3" href="https://www.loadingstudios.archive.tornadocore.es/panel/index/estado/soporte">Soporte</a>
    </div>
...
?>
 ...
 if(estado ==="inicio")
 {
     $("#resultado_inicio").load("https://www.loadingstudios.archive.tornadocore.es/panel/obtener_inicio");
  ...
  if(estado ==="facturacion")
 {
     $("#resultado_facutras").load("https://www.loadingstudios.archive.tornadocore.es/panel/obtener_facturas");
   ...
   if(estado ==="soporte")
 {
     $("#resultado_soporte").load("https://www.loadingstudios.archive.tornadocore.es/panel/obtener_chat");
     $("#resultado_soporte_comentario").load("https://www.loadingstudios.archive.tornadocore.es/panel/obtener_chat_comentario");
